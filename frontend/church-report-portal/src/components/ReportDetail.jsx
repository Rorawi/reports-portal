...
const ReportDetail = () => {
	...
	console.log(report.baptism.baptizedInHolySpiritOldMembersCurrent);
		...
		<>
			...
			<div className="p-4 bg-white dark:bg-[#212121] dark:border-[#333333] rounded-xl shadow">
				...
				<div className="flex flex-col md:flex-row justify-between items-start gap-4 mb-3">
					<h4 className="text-3xl font-medium text-gray-600 dark:text-white mb-3">
				...
				<div className="border-[#8f8f8f2c] border-t mt-6 pt-3 pb-0">
					<div className="flex justify-end items-center gap-3">
						...
						{!report.isApproved && ( 
						<div
							className="p-3 w-fit text-xs rounded-md flex-shrink-0 flex justify-center items-center gap-1 shadow-md cursor-pointer bg-[#1a9b50] border border-[#1a9b50] dark:border-[#5aff9f] dark:bg-[#223124] text-[#fff]"
