...

{
	...
	<div
		className="p-3 w-fit rounded-full flex-shrink-0 flex justify-center items-center gap-1 shadow-md cursor-pointer dark:bg-[#333333] dark:text-white border border-[#333333]"
		title="Mark as Read"
	>
		<IoCheckmarkDoneSharp className="w-4 h-4 dark:text-white" />
		<span className="text-xs hidden"> Download </span>
	</div>
    
//If report is read
	<div
		className="p-3 w-fit rounded-full flex-shrink-0 flex justify-center items-center gap-1 shadow-md cursor-pointer bg-blue-500 text-white dark:bg-[#2564eb22] border border-blue-500 dark:text-white"
		title="Mark as Read"
	>
		<IoCheckmarkDoneSharp className="w-4 h-4 dark:text-blue-600" />
		<span className="text-xs hidden"> Download </span>
	</div>
</div> */
}
